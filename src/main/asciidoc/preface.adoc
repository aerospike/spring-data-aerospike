...
https://docs.spring.io/spring-framework/reference/core.html[core] functionality, such as
the https://docs.spring.io/spring-framework/reference/core/beans.html[IoC] container,
https://docs.spring.io/spring-framework/reference/core/validation/convert.html[type conversion system],
https://docs.spring.io/spring-framework/reference/data-access/dao.html#dao-exceptions[DAO exception hierarchy]
