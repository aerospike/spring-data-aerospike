...
For more details refer to SpringData documentation: xref:{docdir}/../spring-data-commons-docs/repository-projections.adoc#projections[Repository projections].
