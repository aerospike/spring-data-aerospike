...
* Spring configuration support using Java based @Configuration classes or an XML namespace for Aerospike driver instance and replica sets
...
For more information see xref:template.adoc#aerospike.template[AerospikeTemplate] for more information.
