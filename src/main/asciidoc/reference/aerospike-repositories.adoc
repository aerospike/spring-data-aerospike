...
link:https://github.com/aerospike/spring-data-aerospike/blob/main/examples/src/main/java/org/springframework/data/aerospike/examples/blocking/customquery/CustomQueryDslExample.java[custom DSL queries].
...
public class RepositoryExample {
	...
	protected void setUp() {
		...
		repository.createIndex(Person.class, "person_name_index", "name",
				IndexType.STRING);
		List<Person> all = (List<Person>) repository.saveAll(Arrays.asList(oliver,
