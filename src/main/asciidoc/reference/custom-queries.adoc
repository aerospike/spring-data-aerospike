...
Regular repository queries are obviously helpful for most of the querying tasks. Each of the repositories
adds more functionality by providing its query methods.
