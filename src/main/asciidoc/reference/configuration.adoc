...
spring-data-aerospike.data.send-key=false
...
as well as `configureDataSettings()` method of the `AbstractAerospikeDataConfiguration` class.
...
class ApplicationConfig extends AbstractAerospikeDataConfiguration {
    ...
    @Override
    public AerospikeDataSettings configureDataSettings() {
