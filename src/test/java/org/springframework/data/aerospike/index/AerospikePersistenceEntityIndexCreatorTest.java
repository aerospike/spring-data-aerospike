...
class AerospikePersistenceEntityIndexCreatorTest {
    ...
    final AerospikePersistenceEntityIndexCreator creator = new AerospikePersistenceEntityIndexCreator(null,
        createIndexesOnStartup, aerospikeIndexResolver, template);
