...
public class BlockingIndexedExistsEqualsTests extends IndexedPersonRepositoryQueryTests {
    ...
    protected List<Index> newIndexes() {
        ...
        newIndexes.add(Index.builder()
                ...
                .name("indexed_person_last_name_" + "exists_equals")
                .bin("lastName")
                .indexType(STRING)
                .build());
        return newIndexes;
    ...
    public void equalsBySimpleProperty_String() {
        assertThat(repository.countByLastName("Lerois")).isZero();
        assertThat(repository.countByLastName("James")).isEqualTo(1);

        assertQueryHasSecIndexFilter("existsByLastName", IndexedPerson.class, "James");
        assertThat(repository.existsByLastName("James")).isTrue();
    }
}
