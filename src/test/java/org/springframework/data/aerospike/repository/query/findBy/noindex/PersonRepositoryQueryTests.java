...
public class PersonRepositoryQueryTests extends BaseBlockingIntegrationTests {
    ...
    static final Person dave = Person.builder()
        .id(nextId())
        .firstName("Dave")
        .lastName("Matthews")
        .age(42)
        ...
        .build();
    static final Person donny = Person.builder()
        .id(nextId())
        .firstName("Donny")
        .lastName("Macintire")
        .age(39)
        ...
        .build();
    static final Person oliver = Person.builder()
        .id(nextId())
        ...
        .build();
    static final Person alicia = Person.builder()
        .id(nextId())
        .firstName("Alicia")
        .lastName("Keys")
        .age(30)
        ...
        .build();
    static final Person carter = Person.builder()
        .id(nextId())
        .firstName("Carter")
        .lastName("Beauford")
        .age(49)
        ...
        .build();
    static final Person boyd = Person.builder()
        .id(nextId())
        .firstName("Boyd")
        .lastName("Tinsley")
        .age(45)
        ...
        .build();
    static final Person stefan = Person.builder()
        .id(nextId())
        .firstName("Stefan")
        .lastName("Lessard")
        .age(34)
        .build();
    static final Person leroi = Person.builder()
        .id(nextId())
        .firstName("Leroi")
        .lastName("Moore")
        .age(44)
        ...
        .build();
    static final Person leroi2 = Person.builder()
        .id(nextId())
        .firstName("Leroi")
        .lastName("Moore")
        .age(25)
        .build();
    static final Person matias = Person.builder()
        .id(nextId())
        .firstName("Matias")
        .lastName("Craft")
        .age(24)
        ...
        .build();
    static final Person douglas = Person.builder()
        .id(nextId())
        .firstName("Douglas")
        .lastName("Ford")
        .age(25)
