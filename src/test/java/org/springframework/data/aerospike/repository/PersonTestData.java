...
public class PersonTestData {
    ...
    public static Person carter = Person.builder().id(nextId()).firstName("Carter").lastName("Beauford").age(49).intMap(of(1, 0, 2, 1))
    ...
    public static Person leroi = Person.builder().id(nextId()).firstName("Leroi").lastName("Moore").age(41).intMap(of(1, 0, 2, 1)).build();
