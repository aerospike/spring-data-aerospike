...
public class ReactiveAerospikeTemplateTransactionUnitTests extends BaseReactiveIntegrationTests {
    ...
    public void beforeAll() {
        ...
        utils = new ReactiveAerospikeTransactionTestUtils(reactorClient, reactiveTemplate, transactionManager);
    }
    ...
    public void persistInTransaction_verifyCommit() {
        ...
        Mono<DocumentWithPrimitiveIntId> action =
            reactiveTemplate.persist(document, reactorClient.getWritePolicyDefault());
    ...
    public void verifyOngoingTransaction_withPropagation_required() {
        DocumentWithPrimitiveIntId doc = new DocumentWithPrimitiveIntId(701);
    ...
    public void verifyOngoingTransaction_withPropagation_requiresNew() {
        DocumentWithPrimitiveIntId doc = new DocumentWithPrimitiveIntId(702);
    ...
    public void verifyOngoingTransaction_withPropagation_supports() {
        DocumentWithPrimitiveIntId doc = new DocumentWithPrimitiveIntId(700);
    ...
    public void verifyOngoingTransaction_withPropagation_notSupported() {
        DocumentWithPrimitiveIntId doc = new DocumentWithPrimitiveIntId(703);
    ...
    public void verifyOngoingTransaction_withPropagation_mandatory() {
        DocumentWithPrimitiveIntId doc = new DocumentWithPrimitiveIntId(704);
    ...
    public void verifyOngoingTransaction_withPropagation_never() {
        DocumentWithPrimitiveIntId doc = new DocumentWithPrimitiveIntId(706);
    ...
    public void verifyOngoingTransaction_withPropagation_nested() {
        DocumentWithPrimitiveIntId doc = new DocumentWithPrimitiveIntId(707);
        ...
        transactionalOperator
            .execute(transaction -> forCurrentTransaction()
                .doOnNext(synchronizationManager -> {
                    ...
                    assertThat(synchronizationManager.hasResource(reactorClient)).isTrue();
