...
The Spring Data Aerospike project aims to provide a familiar and consistent Spring-based programming model for data
...
Framework-owned runnable reference examples are available in
link:examples/README.adoc[`examples/`]. They compile against the current repository sources through the opt-in Maven
`examples` profile and can be listed with:
...
Demo applications and more detailed guides remain in the
...
|6.3.x  |4.1.x |10.4.x |10.5.x |6.1.x.x +

|6.2.x  |4.1.x |10.4.x |10.4.x |6.1.x.x +

|6.1.x  |4.0.x |10.2.x |10.2.x |6.1.x.x +

|6.0.x  |4.0.x |10.0.x |10.0.x |6.1.x.x +
