...
public class BlockingLogicalProgrammaticScanConfiguration extends AbstractAerospikeDataConfiguration {

    @Bean
    BlockingLogicalProgrammaticIndexedScanExample blockingLogicalProgrammaticIndexedScanExample(
        BlockingLogicalProgrammaticMovieRepository repository) {
        return new BlockingLogicalProgrammaticIndexedScanExample(repository);
    }

    @Bean
    BlockingLogicalProgrammaticNoIndexExample blockingLogicalProgrammaticNoIndexExample(
        BlockingLogicalProgrammaticMovieRepository repository) {
        return new BlockingLogicalProgrammaticNoIndexExample(repository);
    }
