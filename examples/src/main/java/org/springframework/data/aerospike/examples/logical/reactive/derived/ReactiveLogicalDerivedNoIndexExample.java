...
public class ReactiveLogicalDerivedNoIndexExample {

    private final ReactiveLogicalDerivedMovieRepository repository;

    public ReactiveLogicalDerivedNoIndexExample(ReactiveLogicalDerivedMovieRepository repository) {
        this.repository = repository;
    }

    public void run() {
        LogicalMovieExamples.saveMovies("reactive-derived-no-index", repository);
        ...
        requireTitles(repository.findByGenreAndReleaseYear(of(SCIENCE_FICTION), of(1979))
                .collectList()
                .block(),
            "No-index reactive derived one AND query should scan", "Alien");
        ...
        requireTitles(repository.findByGenreOrReleaseYear(of(CRIME), of(1979))
                .collectList()
                .block(),
            "No-index reactive derived one OR query should scan", "Alien", "Collateral", "Heat");
        ...
        requireTitles(repository.findByGenreAndReleaseYearAndTitle(
                ...
                .collectList()
                .block(),
            "No-index reactive derived multiple AND query should scan", "Alien");
        ...
        requireTitles(repository.findByGenreOrReleaseYearOrTitle(
                ...
                .collectList()
                .block(),
            "No-index reactive derived multiple OR query should scan", "Alien", "Collateral", "Heat", "Network");
        ...
        requireTitles(repository.findByGenreAndReleaseYearOrTitle(
                ...
                .collectList()
                .block(),
            "No-index reactive derived mixed query should scan", "Alien", "Heat");

        System.out.println("Ran reactive derived logical queries in a scan-enabled no-index context");
    }
}
